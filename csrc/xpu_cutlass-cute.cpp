...
template <typename T, size_t GROUP_SIZE, size_t NUM_PER_THREAD,
          size_t SUBG_SIZE, int BITS>
SYCL_EXTERNAL void kgemv_4bit_inference_cutlass<T, GROUP_SIZE, NUM_PER_THREAD, SUBG_SIZE,
  ...
  size_t workspace_size = get_workspace_size(arguments);
...
//    sycl_kernel_submit<decltype(GemmKernel), 1, 32>(
