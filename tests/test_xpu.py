...
class TestXPU:
    ...
    def test_embedding_lossless(self, device, embedding_class, input_shape, embedding_dim, quant_storage):
        if device == "hpu":
    ...
    @pytest.mark.parametrize("blocksize", [8192, 64, 128, 256, 512, 1024, 2048, 4096])
