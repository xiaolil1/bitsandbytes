...
void gemv_4bit_inference(int m, int n, int k, T *A, unsigned char *B,
  ...
  // Create the Epilogue
  using EpilogueOp = cutlass::epilogue::fusion::LinearCombination<T /*data_type of GEMM output*/, ElementComputeEpilogue, ElementAccumulator, ElementAccumulator, cutlass::FloatRoundStyle::round_to_nearest>;
